...
public final class Log4j2ContextDataProvider extends ContextDataProvider {
  ...
  static final Log4j2ContextDataProvider INSTANCE = new Log4j2ContextDataProvider();
  ...
  private Log4j2ContextDataProvider() {}
  ...
  public ScopedLoggingContext getContextApiSingleton() {
    ...
    return Log4j2ScopedLoggingContext.getGrpcConfigInstance();
  }

  @Override
  public Tags getTags() {
    return Log4j2ContextData.getTagsFor(currentContext());
  }

  @Override
  public ScopeMetadata getMetadata() {
    return Log4j2ContextData.getMetadataFor(currentContext());
  }
  ...
  public boolean shouldForceLogging(String loggerName, Level level, boolean isEnabledByLevel) {
    ...
    return hasLogLevelMap
        && Log4j2ContextData.shouldForceLoggingFor(currentContext(), loggerName, level);
  }
  ...
  private static final class KeyHolder {
    private static final Context.Key<Log4j2ContextData> GRPC_SCOPE =
