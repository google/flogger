 ...
 * {@link AbstractMessageLogger#at(Level)} method, and normally lasts only as long as the log statement.
 * <p>
...
public abstract class LogContext<
        LOGGER extends AbstractMessageLogger<API>, API extends LoggingApi<API>>
