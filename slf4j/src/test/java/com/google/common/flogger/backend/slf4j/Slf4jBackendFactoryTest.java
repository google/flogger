...
/** Tests specific to the {@link Slf4j2BackendFactory} implementation. */
@RunWith(JUnit4.class)
public final class Slf4jBackendFactoryTest {
  ...
  public void testCanLoadWithServiceLoader() {
    ...
    assertThat(factories.get(0)).isInstanceOf(Slf4jBackendFactory.class);
  }
}
