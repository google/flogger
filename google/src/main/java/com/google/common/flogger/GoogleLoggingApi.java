 ...
 *
 * <p>If a team wishes to implement its own logging extensions, it must extend this API (in the same
 ...
 *
 * <p>However, if you wish to extend the default logging API, please contact flogger-dev@ first.
 *
